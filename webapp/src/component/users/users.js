...
const headCells = [
    ...
    { id: 'calories', numeric: true, disablePadding: false, label: 'Forward to device' },
    { id: 'fat', numeric: true, disablePadding: false, label: 'Availablity' },
    { id: 'carbs', numeric: true, disablePadding: false, label: 'Numbers' },
